...
- With an increase in shot distance:
  - The time between upper extremity shot initiation and CM trajectory apex increased
  - The ball vertical velocity at released increased
...
- Shot distance affects the magnitude and timing of upper extremity joint max angular velocities [@Nakano2018; @Podmenik2017; @Miller1993] relative to ball release
- Releasing the ball earlier relative to CM trajectory apex uses more of the CM vertical velocity and relies less on the arms [@Wiens2020]
- Upper extremity shot initiation occurs earlier relative to the CM trajectory apex when shot distance increases
